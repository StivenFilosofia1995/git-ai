...
class Settings(BaseSettings):
    ...
    # Anthropic (Claude) — deshabilitado actualmente, se conserva solo por compatibilidad
    ...
    # Gemini (Google AI) — fallback si Ollama no responde
    gemini_api_key: str = ""
    ...
    # Ticketmaster Discovery API (gratuita, 5000 llamadas/día)
    # Registro: https://developer.ticketmaster.com/
    ticketmaster_api_key: str = ""

    # Eventbrite API v3 (gratuita para eventos públicos)
