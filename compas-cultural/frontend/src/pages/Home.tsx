    ...
    <>
      ...
      <section className="relative bg-white border-b-2 border-black overflow-hidden">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute right-0 bottom-0 w-[42%] sm:w-[38%] lg:w-[36%] h-auto object-contain object-bottom pointer-events-none select-none opacity-[0.15] mix-blend-multiply"
