...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ user, session, loading, perfilCompleto, perfilLoading, marcarPerfilCompleto, signUp, signIn, signInWithGoogle, signOut, resetPassword, updatePassword }}>
      {children}
